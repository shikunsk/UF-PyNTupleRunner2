...
bkgSkimTreeDir3     = system.getStoragePath()+"/Zprime/20211023_Zto4l/SkimTree_Run2017_MMM_MC/"
bkgSkimTreeDir      = "/cmsuf/data/store/user/t2/users/kshi/Zprime/Ultra_Legacy/background/2017/" 
...
bkgTreeDir3         = "/cmsuf/data/store/user/t2/users/klo/Higgs/DarkZ/NTuples/BkgMC_Run2017/"
...
#dataTreeDir         = system.getStoragePath()+"/Zprime/20211023_Zto4l/SkimTree_Run2017_MMM_Data/"
dataTreeDir         = "/cmsuf/data/store/user/t2/users/kshi/Zprime/Ultra_Legacy/data/2017/"
...
data2017_cmpList = ComponentList(
        [ 
            ...
            Component("Data2017",dataTreeDir+"Data_2017_UL_MiniAODv2_skim2L_noDuplicates.root","passedEvents",inUFTier2=inUFTier2),
...
qqZZ_cmpList = ComponentList(
        [ 
            ...
            Component("qqZZTo4L",bkgSkimTreeDir+"ZZTo4L_M125_2017_skimmed.root","passedEvents",inUFTier2=inUFTier2),
        ]
        )
...
ggZZTo4L_cmpList = ComponentList(
        [ 
            ...
            Component("ggZZTo4tau",bkgSkimTreeDir+"GluGluToContinToZZTo4tau_M125_2017_skimmed.root","passedEvents",inUFTier2=inUFTier2),
        ]
        )
...
handleSumWeight(
        ...
        bkgTreeDir+"GluGluToContinToZZTo4tau_M125_2017_skimmed.root",
        sumWeightHist,
        True,
        saveSumWeightTxt,
        #bkgSkimTreeDir+"GluGluToContinToZZTo4tau_13TeV_MCFM701_pythia8.txt",
        bkgSkimTreeDir+"GluGluToContinToZZTo4tau_M125_2017_skimmed.txt",
        #bkgSkimTreeDir+"GluGluToContinToZZTo4tau_13TeV_MCFM701_pythia8.txt",
        )
...
ggZZTo4L_cmpList = ComponentList(
        [ 
            ...
            Component("ggZZTo4e",bkgSkimTreeDir+"GluGluToContinToZZTo4e_M125_2017_skimmed.root","passedEvents",inUFTier2=inUFTier2),
        ]
        )
...
handleSumWeight(
        ...
        bkgTreeDir+"GluGluToContinToZZTo4e_M125_2017_skimmed.root",
        sumWeightHist,
        True,
        saveSumWeightTxt,
        #bkgSkimTreeDir+"GluGluToContinToZZTo4e_13TeV_MCFM701_pythia8.txt",
        bkgSkimTreeDir+"GluGluToContinToZZTo4e_M125_2017_skimmed.txt",
        #bkgSkimTreeDir+"GluGluToContinToZZTo4e_13TeV_MCFM701_pythia8.txt",
        )
...
ggZZTo4L_cmpList = ComponentList(
        [ 
            ...
            Component("ggZZTo4mu",bkgSkimTreeDir+"GluGluToContinToZZTo4mu_M125_2017_skimmed.root","passedEvents",inUFTier2=inUFTier2),
        ]
        )
...
handleSumWeight(
        ...
        bkgTreeDir+"GluGluToContinToZZTo4mu_M125_2017_skimmed.root",
        sumWeightHist,
        True,
        saveSumWeightTxt,
        #bkgSkimTreeDir+"GluGluToContinToZZTo4mu_13TeV_MCFM701_pythia8.txt",
        bkgSkimTreeDir+"GluGluToContinToZZTo4mu_M125_2017_skimmed.txt",
        #bkgSkimTreeDir+"GluGluToContinToZZTo4mu_13TeV_MCFM701_pythia8.txt",
        )
...
ggZZTo4L_cmpList = ComponentList(
        [ 
            ...
            Component("ggZZTo2mu2tau",bkgSkimTreeDir+"GluGluToContinToZZTo2mu2tau_M125_2017_skimmed.root","passedEvents",inUFTier2=inUFTier2),
        ]
        )
...
handleSumWeight(
        ...
        bkgTreeDir+"GluGluToContinToZZTo2mu2tau_M125_2017_skimmed.root",
        sumWeightHist,
        True,
        saveSumWeightTxt,
        #bkgSkimTreeDir+"GluGluToContinToZZTo2mu2tau_13TeV_MCFM701_pythia8.txt",
        bkgSkimTreeDir+"GluGluToContinToZZTo2mu2tau_M125_2017_skimmed.txt",
        #bkgSkimTreeDir+"GluGluToContinToZZTo2mu2tau_13TeV_MCFM701_pythia8.txt",
        )
...
ggZZTo4L_cmpList = ComponentList(
        [ 
            ...
            Component("ggZZTo2e2mu",bkgSkimTreeDir+"GluGluToContinToZZTo2e2mu_M125_2017_skimmed.root","passedEvents",inUFTier2=inUFTier2),
        ]
        )
...
handleSumWeight(
        ...
        bkgTreeDir+"GluGluToContinToZZTo2e2mu_M125_2017_skimmed.root",
        sumWeightHist,
        True,
        saveSumWeightTxt,
        #bkgSkimTreeDir+"GluGluToContinToZZTo2e2mu_13TeV_MCFM701_pythia8.txt",
        bkgSkimTreeDir+"GluGluToContinToZZTo2e2mu_M125_2017_skimmed.txt",
        #bkgSkimTreeDir+"GluGluToContinToZZTo2e2mu_13TeV_MCFM701_pythia8.txt",
        )
...
ggZZTo4L_cmpList = ComponentList(
        [ 
            ...
            Component("ggZZTo2e2tau",bkgSkimTreeDir+"GluGluToContinToZZTo2e2tau_M125_2017_skimmed.root","passedEvents",inUFTier2=inUFTier2),
        ]
        )
...
handleSumWeight(
        ...
        bkgTreeDir+"GluGluToContinToZZTo2e2tau_M125_2017_skimmed.root",
        sumWeightHist,
        True,
        saveSumWeightTxt,
        #bkgSkimTreeDir+"GluGluToContinToZZTo2e2tau_13TeV_MCFM701_pythia8.txt",
        bkgSkimTreeDir+"GluGluToContinToZZTo2e2tau_M125_2017_skimmed.txt",
        #bkgSkimTreeDir+"GluGluToContinToZZTo2e2tau_13TeV_MCFM701_pythia8.txt",
        )
"""
# ____________________________________________________________________________________________________________________________________________ ||
